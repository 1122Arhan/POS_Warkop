...
@section('content')
    <div class="card">
        ...
        <h3 class="card-title">
            <a href="/kategori/form/" class="btn btn-primary"><i class="fa fa-folder-plus"></i> Tambah Data</a>
        </h3>
            ...
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>{{$no++}}</td>
                        <td>{{$item->nama_ktg}}</td>
                        <td>{{$item->jenis_ktg}}</td>
                        <td>
                            <a href="/kategori/edit/{{$item->id}}" class="btn btn-info btn-sm"><i class="fa fa-pencil-alt"></i></a>
